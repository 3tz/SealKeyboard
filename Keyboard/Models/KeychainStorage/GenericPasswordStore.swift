...
struct GenericPasswordStore {
  ...
  /// Update an existing key with the given account.
  func updateKey<T: GenericPasswordConvertible>(newKey: T, account: String) throws {
    ...
    let attributes = [
      kSecValueData: newKey.rawRepresentation
    ] as [String: Any]
